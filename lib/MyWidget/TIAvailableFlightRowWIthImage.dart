...
class TIAvailableFlightRowWithImage extends StatelessWidget {
  int index;
  bool isSelected;
  TIAvailableFlightRowWithImage(this.index, isSelected);
      ...
      children: [
        Container(
          ...
          child: Row(
            ...
            children: [
               Image.network("https://webapi.etravos.com${myController.myIntOnwordsList1.value[index][0].imagePath}",width: 50,height: 50,),
              Column(
                ...
                children: [
                  MyTextStart(
                    ...
                    text_name:myController.myIntOnwordsList1.value[index][0].airLineName.toString(),
                    myFont: MyFont.Courier_Prime_Bold,
                    txtfontsize: MyFontSize.size10,
                  ),
                  MyTextStart(
                   text_name: myController.myIntOnwordsList1.value[index][0].intNumStops == "0" ? "NonStop": "stop : ${myController.myIntOnwordsList1.value[index][0].intNumStops}",
              ...
              Column(
                ...
                children: [
                  MyTextStart(
                    text_name:myController.myIntOnwordsList1.value[index][0].duration,
                    myFont: MyFont.Courier_Prime_Bold,
                    txtfontsize: MyFontSize.size10,
                  ),
                  MyTextStart(
                    text_name: "${myController.myIntOnwordsList1.value[index][0].departureAirportCode} -  ${myController.myIntOnwordsList1.value[index][0].arrivalAirportCode}",
                    myFont: MyFont.Courier_Prime,
                    txtfontsize: MyFontSize.size10,
                  )
