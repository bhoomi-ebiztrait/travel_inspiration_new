...
//==============my account mode of transport==============//
  ...
  static String txtLangue="txtLangue".tr;
...
//======my account notification=======//
  ...
  static String txtNotificationdu="Notifications du nombre de kilomètres parcourus à mi-parcours de la semaine";
  static String txtVacanceen="Vacances en approche";
  static String txtRecevoir="Recevoir une notification 5 jours avant la date de ton départ pour vérifier que tout est prêt";
